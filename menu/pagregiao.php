...
<body>
  ...
  <a class="navbar-brand" href="tela1.php">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="pagregiao.php">Região</a>
        </li>
      ...
      <form class="d-flex" role="search" action="../search/search.php?comando=3" method="post">
        <input name="pesquisar_regiao" class="form-control me-2" type="search" placeholder="Search" aria-label="Search">
  ...
  <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
            ...
            <div class="card-button">
                <div>
                    <button><a class="button" href="../forms/regform.php">Cadastrar</a></button>
                </div>
            </div>
